  ...
  template: `
    <div class="garden-details-page">
      ...
      <h4 class="garden-details-page__subtitle">
        Explore the detailed information about your
        selected garden, including its location, plants, and maintenance schedule.
      </h4>
      <div class="garden-details-page__card">
        <form [formGroup]="gardenForm" class="garden-details-page__form">
          <div class="garden-details-page__form-group">
            ...
            <input type="text" id="name" class="garden-details-page__form-control"
            formControlName="name">
          </div>
          <div class="garden-details-page__form-group">
            <label for="location" class="garden-details-page__form-label">Garden
            Location</label>
            <input type="text" id="location" class="garden-details-page__form-control"
            formControlName="location">
          </div>
          <div class="garden-details-page__form-group">
            <label for="description" class="garden-details-page__form-label">Garden
            Description</label>
            <textarea id="description" rows="10" class="garden-details-page__form-control"
