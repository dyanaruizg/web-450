      ...
      <div class="plant-add-page__card">
        <form [formGroup]="plantForm" class="plant-add-page__form">
          <div class="plant-add-page__form-group">
            ...
            <input type="text" id="name" class="plant-add-page__form-control"
          ...
          <div class="plant-add-page__form-group">
            ...
            <select id="status" class="plant-add-page__form-control"
          ...
          <div class="plant-add-page__form-group">
            ...
            <select id="gardenId" class="plant-add-page__form-control"
          ...
          <div class="plant-add-page__form-group">
            ...
            <input type="date" id="datePlanted" class="plant-add-page__form-control"
...
export class PlantAddComponent {
  ...
  constructor(private fb: FormBuilder, private router: Router, private plantService:
    PlantService, private gardenService: GardenService) {
