      ...
      <div class="garden-add-page__card">
        <form [formGroup]="gardenForm" class="garden-add-page__form">
          <div class="garden-add-page__form-group">
            ...
            <input type="text" id="name" class="garden-add-page__form-control"
            formControlName="name">
          </div>
          <div class="garden-add-page__form-group">
            <label for="location" class="garden-add-page__form-label">Garden
            Location</label>
            <input type="text" id="location" class="garden-add-page__form-control"
            formControlName="location">
          </div>
          <div class="garden-add-page__form-group">
            <label for="description" class="garden-add-page__form-label">Garden
            Description</label>
            <textarea id="description" rows="10" class="garden-add-page__form-control"
            formControlName="description"></textarea>
          </div>
          <div class="garden-add-page__form-group">
            <label for="dateCreated" class="garden-add-page__form-label">Date
            Created</label>
            <input type="datetime-local" id="dateCreated" class="garden-add-page__form-
            control" formControlName="dateCreated">
          </div>
