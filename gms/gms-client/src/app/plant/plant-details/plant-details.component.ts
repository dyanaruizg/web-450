...
@Component({
  ...
  template: `
    <div class="plant-details-page">
      ...
      <h4 class="plant-details-page__subtitle">Explore the detailed information about your
      selected plant, including its type and status.</h4>
      <div class="plant-details-page__card">
        <form [formGroup]="plantForm" class="plant-details-page__form">
          <div class="plant-details-page__form-group">
            ...
            <input type="text" id="name" class="plant-details-page__form-control"
            formControlName="name">
          </div>
          <div class="plant-details-page__form-group">
            <label for="type" class="plant-details-page__form-label">Plant Type</label>
            <select id="type" class="plant-details-page__form-control"
          ...
          <div class="plant-details-page__form-group">
            ...
            <select id="status" class="plant-details-page__form-control"
